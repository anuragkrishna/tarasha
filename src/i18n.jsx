...
const STRINGS = {
  en: {
    ...
    whatSheSaid: 'What she said:',
    caregiverHowNarration: 'Caregiver: How was the narration?',
    caregiverHowDescription: 'Caregiver: How was the description?',
    writeDescription: 'Write what she described here...',
    sentencesTarget: 'Try to say at least {n} sentences.',
    sentenceTarget: 'Try to say at least {n} sentence.',
  ...
  hi: {
    ...
    whatSheSaid: 'उसने क्या कहा:',
    caregiverHowNarration: 'आप बताएँ: कहानी कैसी सुनाई?',
    caregiverHowDescription: 'आप बताएँ: कैसा बताया?',
    writeDescription: 'उसने जो बताया वह यहाँ लिखें...',
    sentencesTarget: 'कम से कम {n} वाक्य बोलने की कोशिश करें।',
    sentenceTarget: 'कम से कम {n} वाक्य बोलने की कोशिश करें।',
