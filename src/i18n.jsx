...
const STRINGS = {
  en: {
    ...
    clapBegin: 'Begin',
    clapPlaying: 'Playing…',
    clapRuleTap: 'Tap on the word. Stay still otherwise.',
    clapRuleClap: 'Clap on the word. Stay quiet otherwise.',
  ...
  hi: {
    ...
    clapRuleTap: 'शब्द पर दबाएँ। बाकी समय रुके रहें।',
    clapRuleClap: 'शब्द पर ताली। बाकी समय चुप रहें।',
